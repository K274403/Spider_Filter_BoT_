...
BOT_TOKEN = environ.get('BOT_TOKEN', "7401908453:AAFc1-i5WHvtRkqCdBivG8pzM7k5K4_10QQ")
...
PICS = (environ.get('PICS', 'https://envs.sh/IBu.jpg ')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1798348973 6174868004').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002156162334')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002156162334')
...
GRP_LNK = environ.get('GRP_LNK', 'http://t.me/cinemaa_time')
CHNL_LNK = environ.get('CHNL_LNK', 'http://t.me/rkmovieszip')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/cinemaa_time')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002186335716'))
